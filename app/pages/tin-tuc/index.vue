   ...
   <div class="bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      ...
      <section class="border-b border-gray-200 dark:border-gray-800 bg-gray-100/70 dark:bg-gray-900/40">
         <div class="container mx-auto px-6 py-12">
            ...
            <h1 class="text-4xl font-extrabold tracking-tight mb-2">Tin tức</h1>
      ...
      <section class="container mx-auto px-6 py-6">
         ...
         <NuxtLink v-if="featured" to="/tin-tuc/bai-viet"
            class="grid md:grid-cols-[1.15fr_0.85fr] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden mb-9">
            <div
               class="ph aspect-16/10 flex items-center justify-center">
...
useHead({ title: 'Tin tức & phân tích' })

const categories = ['Tất cả', 'Thời sự', 'Pháp luật', 'Doanh nghiệp', 'Phân tích', 'Hỏi đáp']

const posts: Post[] = [
   { tag: 'Thời sự', title: 'TAND TP.HCM mở thủ tục phá sản với doanh nghiệp bất động sản lớn phía Nam', excerpt: 'Quyết định được ban hành sau khi doanh nghiệp mất khả năng thanh toán các khoản nợ đến hạn kéo dài.', meta: '2 giờ trước' },
   { tag: 'Pháp luật', title: 'Sửa đổi Luật Phá sản 2014: 5 điểm mới doanh nghiệp cần nắm rõ', excerpt: 'Những thay đổi quan trọng về trình tự, thủ tục và vai trò của các bên trong quá trình giải quyết phá sản.', meta: '4 giờ trước' },
   { tag: 'Phân tích', title: 'Tái cơ cấu nợ thành công: bài học từ một doanh nghiệp sản xuất', excerpt: 'Hành trình từ bờ vực mất khả năng thanh toán đến phục hồi hoạt động ổn định trở lại.', meta: 'Hôm qua' },
   { tag: 'Pháp luật', title: 'Quy trình chỉ định và thù lao của quản tài viên theo quy định mới', excerpt: 'Điều kiện hành nghề, phạm vi trách nhiệm và cách tính thù lao của quản tài viên.', meta: '5 giờ trước' },
   { tag: 'Pháp luật', title: 'Thứ tự ưu tiên thanh toán khi doanh nghiệp bị tuyên bố phá sản', excerpt: 'Nguyên tắc phân chia tài sản và bảo vệ quyền lợi các nhóm chủ nợ khác nhau.', meta: '7 giờ trước' },
   { tag: 'Doanh nghiệp', title: 'Hội nghị chủ nợ: điều kiện hợp lệ và quyền biểu quyết', excerpt: 'Vai trò của hội nghị chủ nợ trong việc thông qua phương án phục hồi hoạt động kinh doanh.', meta: 'Hôm qua' },
   { tag: 'Hỏi đáp', title: 'Phân biệt phá sản và giải thể doanh nghiệp dưới góc nhìn pháp lý', excerpt: 'Hai khái niệm dễ nhầm lẫn nhưng khác biệt về bản chất, thủ tục và hệ quả pháp lý.', meta: '2 ngày trước' },
   { tag: 'Doanh nghiệp', title: 'Bảo vệ quyền lợi người lao động khi doanh nghiệp mất khả năng chi trả', excerpt: 'Các khoản lương, trợ cấp và bảo hiểm xã hội được ưu tiên xử lý như thế nào.', meta: '2 ngày trước' },
   { tag: 'Phân tích', title: 'Nguyên tắc định giá tài sản trong thủ tục phá sản', excerpt: 'Phương pháp định giá, tổ chức thẩm định và bán đấu giá tài sản minh bạch.', meta: '3 ngày trước' }
]
...
const filtered = computed(() =>
   activeCategory.value === 'Tất cả'
      ? posts
      : posts.filter((p) => p.tag === activeCategory.value)
)
...
<style scoped>
.ph {
   background: repeating-linear-gradient(135deg, rgba(15, 86, 179, 0.09) 0 10px, transparent 10px 20px), rgb(231 240 252);
}
